...
export default function SinglePost() {
	...
	return (
		<div className={style.singleCardContent}>
			<Link href={`${pathname}/:postId`} className={style.singleImgBox}>
			...
			<div className={style.singleCardPost}>
				...
				<Link href={`${pathname}/:postId`} className={style.singleCardTitle}>
					스튜디오 촬영 가능한 모델 구합니다! 스튜디오 촬영 가능한 모델 구합니다!
				</Link>
				<p className={style.singleCardCalendarDate}>
					2024.03.13. 금요일 오후 12:00 ~ 2024.03.13. 금요일 오후 01:00
				</p>
