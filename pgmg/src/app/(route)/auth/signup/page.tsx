	...
	return (
		<div className={styles.Container}>
			...
			<div className={styles.CheckListForm}>
				...
				{agreeOne?
				<button className={styles.AgreeBtn}  onClick={agreeOneHandler}>동의합니다.</button>
					:<button className={styles.NotAgreeBtn}  onClick={agreeOneHandler}>동의합니다.</button>
				}
				...
				{agreeTwo?
					<button className={styles.AgreeBtn}  onClick={agreeTwoHandler}>동의합니다.</button>
					:<button className={styles.NotAgreeBtn}  onClick={agreeTwoHandler}>동의합니다.</button>
				}
				<div className={styles.CheckListInfo}>
				...
				{agreeThree?
					<button className={styles.AgreeBtn}  onClick={agreeThreeHandler}>동의합니다.</button>
					:<button className={styles.NotAgreeBtn}  onClick={agreeThreeHandler}>동의합니다.</button>
				}
			</div>
			<div className={styles.NextBtnDiv}>
			<button className={styles.NextBtn} onClick={HandlerNextPage}>다음</button>
			</div>
		</div>
	);
}
